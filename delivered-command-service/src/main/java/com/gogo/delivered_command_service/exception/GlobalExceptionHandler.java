package com.gogo.delivered_command_service.exception;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(DeliveredCommandNotFoundException.class)
    public ResponseEntity<?> handleResourceNotFoundException(DeliveredCommandNotFoundException exception){
